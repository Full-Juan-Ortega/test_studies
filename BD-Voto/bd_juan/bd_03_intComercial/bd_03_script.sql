...
-- -----------------------------------------------------
-- Table `voto_electronico`.`formas_pago`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `voto_electronico`.`formas_pago` (
  `idformas_pago` INT NOT NULL AUTO_INCREMENT,
  `descripcion_forma de pago` VARCHAR(45) NOT NULL,
  `recargo` VARCHAR(45) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `voto_electronico`.`factura`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `voto_electronico`.`factura` (
  ...
  CONSTRAINT `fk_Factura_formas_pago1`
    ...
    REFERENCES `voto_electronico`.`formas_pago` (`idformas_pago`),
...
-- -----------------------------------------------------
-- Table `voto_electronico`.`tipo_votacion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `voto_electronico`.`tipo_votacion` (
...
CREATE TABLE IF NOT EXISTS `voto_electronico`.`votacion` (
  ...
  CONSTRAINT `fk_votacion_tipo_votacion1`
    ...
    REFERENCES `voto_electronico`.`tipo_votacion` (`idTipo_votacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `voto_electronico`.`producto_llave`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `voto_electronico`.`producto_llave` (
  ...
  CONSTRAINT `fk_producto_llave_Factura1`
    ...
    REFERENCES `voto_electronico`.`factura` (`idFactura`),
